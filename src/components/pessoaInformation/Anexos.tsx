...
import ListCard from './itens/ListCard';
import { StyledSelectInput } from './StyledComponent';
...
const Anexos: FC = () => {
  ...
  const [stackEl, setStackEl] = useState<null | HTMLElement>(null);
  const handleStackMoreOpen = (event: MouseEvent<HTMLButtonElement>) => {
        ...
        <Grid container spacing={4}>
          <Grid item xs={6}>
            ...
            >
              ...
              <MenuItem value="one" sx={{ fontSize: 12, fontWeight: 500 }}>
                One
              </MenuItem>
            </Select>
          </Grid>
